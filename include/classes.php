	...
	function wp_head()
	{
		...
		if($setting_cookie_fingerprint == 'yes')
		{
			...
			$this->footer_output = "<div id='cookies_fingerprint'>
				<i class='fas fa-fingerprint'></i><span>".__("We do not collect or store sensitive information about you as a visitor. If you choose to submit data through forms or log in to the site's admin section, we will only collect the data that you entered.", 'lang_cookies')."</span>
			</div>";
		}
